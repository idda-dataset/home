...
- we compute, in the other, the feature-wise Bhattacharaya [[4]]() distance
- additionally we use tSNE to project the features extracted from the ResNet-101 in a 2D dimensional space 
